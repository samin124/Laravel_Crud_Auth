    ...
    <div class="w-1/2 m-auto border-4 mt-10">
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 bg-red-200" method="POST" action="/insert">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="userid" type="text" name="userid">
            </div>
            <div class="mb-4">
